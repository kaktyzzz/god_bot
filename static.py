...
pray_for_you = 'За Вас помолился %'
prayer_listened = 'Твои молитвы были услышаны. %s обретет успокоение души и тела'
prayer_not_listened = 'Твои молитвы не были услышаны. Продолжай усерднее.'
